 ...
 * @property {Array<{title: string, description: string, beforeImage: string, beforeAlt: string, afterImage: string, afterAlt: string}>} [beforeAfter] - äkta före/efter-par från samma plats, renderas som en egen jämförelsesektion (se templates/partials/beforeAfter.js). Bara med när ett genuint matchande bildpar finns — hoppa annars över fältet helt.
