  ...
  <div class="tpoffcanvas-area">
    <div class="tpoffcanvas">
      ...
      <div class="tpoffcanvas__logo mb-30">
        <a href="/"><img src="/assets/img/logo/haninge.webp" alt="${escapeAttr(site.name)}" width="92" height="46" style="height:46px;width:auto;"></a>
      </div>
        ...
        <div class="col-xl-2 col-lg-3 col-6">
          <div class="tplogo">
            <a href="/" style="display:inline-block;">
              <img src="/assets/img/logo/haninge.webp" alt="${escapeAttr(site.name)}" class="nt-logo-on-dark" width="104" height="52" style="height:52px;width:auto;display:block;">
